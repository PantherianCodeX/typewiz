...
# ignore JUSTIFIED: raw manifest payloads come from untyped JSON and are validated
# into ManifestData by this function
def load_manifest_data(raw: Any) -> ManifestData:  # noqa: ANN401
