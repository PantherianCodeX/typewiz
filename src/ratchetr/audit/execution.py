...
if TYPE_CHECKING:
    ...
    from ratchetr.engines.base import BaseEngine, EngineResult
...
def apply_engine_paths(
    default_include: Sequence[RelPath],
    ...
    Args:
        default_include: Baseline paths supplied by the audit configuration or
            engine options.
...
def resolve_scope_for_mode(
    *,
    ...
    Args:
        ...
        env_paths: Environment variable paths (RATCHETR_INCLUDE).
        config_paths: Config file paths (audit.default_include).
