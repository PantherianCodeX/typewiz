...
def _resolve_default_include(
    ...
    if env_overrides.default_include:
        return env_overrides.default_include

    # 3. Config file setting
    if config.audit.default_include:
        return config.audit.default_include
...
def _build_cli_override(
    ...
    *,
    ...
    override = AuditConfig(
        ...
        default_include=[path for path in args.paths if path] or None,
...
def _prepare_execution_plan(
    ...
    *,
    ...
    selected_default_include = _resolve_default_include(args, config, context.env_overrides)
    if not selected_default_include:
    ...
    return _AuditExecutionPlan(
        ...
        default_include=selected_default_include,
        override=override,
        cli_fail_on=cli_fail_on,
...
def _run_audit_plan(plan: _AuditExecutionPlan) -> AuditResult:
    return run_audit(
        ...
        default_include=plan.default_include,
