...
**Goal:** Ensure a successful rewrite with **no loss**, **no drift**, and **MADR-sized ADRs**, while applying **ADR Rewrite Plan v18** deltas consistently. 
...
- a set of registries (`registers/`) that provide **the canonical record** of:
  ...
  - overlay decisions (Plan v18 deltas),
...
- **Overlay decision:** a Plan v18 delta applied during the rewrite.
...
| Applying Plan v18 deltas | `plan_overlay_register.md`, (often) `delta_register.md` |
