...
**Goal:** Provide an overview of the system to suppoort a successful rewrite with **no loss**, **no drift**, and **MADR-sized ADRs**, while applying **ADR Rewrite Plan v18** deltas consistently. 
**See also:** `README.md` (overview), `AGENTS.md` (full operating standards), and `QUICK_START.md` (guided workflow).
**Date:** 2025-12-19

This folder is the *operational* support package for `docs/_internal/policy/execution-contract-policy.md`.
...
## Canonical locations
- Policy: `docs/_internal/s11r2.md`
- Workbook: `docs/_internal/s11r2/WORKBOOK.md` (Checklists to make tracking easy)
- Registries: `docs/_internal/s11r2/registers/`
- Draft-log mirrors: `docs/_internal/draft_logs/`
- Quick Start: `docs/_internal/s11r2/QUICK_START.md` (Streamlined workflow to get started)
- Usage: `docs/_internal/s11r2/USAGE.md` (Details about the system and how it works)
- Agents: `docs/_internal/s11r2/AGENTS.md` (AI instructions for using this system)
...
5. Apply plan-v18 deltas: log each applied delta in `registers/plan_overlay_register.md`.
