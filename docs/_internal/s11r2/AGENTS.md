...
1. `docs/_internal/s11r2.md` (rewrite governance policy; not the full product spec)
2. `docs/_internal/s11r2/README.md` (how the workbook/registries are used)
3. `docs/_internal/s11r2/registers/registry_index.md` (canonical registry list)
4. `docs/_internal/s11r2/WORKBOOK.md` (the operational loop)
...
`docs/_internal/s11r2/open_questions.md`.
...
1. `docs/_internal/s11r2.md` (governance for the rewrite)
...
- Governance policy: `docs/_internal/s11r2.md`
- Workbook: `docs/_internal/s11r2/WORKBOOK.md`
- Registries (canonical): `docs/_internal/s11r2/registers/`
- Draft-log mirrors: `docs/_internal/draft_logs/`
- Templates: `docs/_internal/s11r2/templates/`
