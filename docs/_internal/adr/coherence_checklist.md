...
**Use:** Run for each rewritten ADR/spec/CLI doc before marking it ready in `docs/_internal/registers/rewrite_status.md`.
...
- [ ] New/changed normative concepts have an entry in `docs/_internal/registers/owner_index.md`.
- [ ] Draft-2 preserved/superseded/deferred concepts have rows in:
  - `docs/_internal/docs/registers/draft2_preservation_map.md` and
  - `docs/_internal/registers/master_mapping_ledger.md` and
  - `docs/_internal/registers/carry_forward_matrix.md` (verbatim vs adapted).
...
- [ ] Any CLI deltas are recorded in `docs/_internal/registers/cli_parity_deltas.md`.
...
- [ ] If any anchor changed, `docs/_internal/registers/anchor_changes.md` is updated.

## Drift control

- [ ] If an amendment/exception occurred, `docs/_internal/registers/change_control.md` is updated and linked.
- [ ] Open Questions are updated (and blockers recorded) as needed in `docs/_internal/registers/open_questions.md`.
