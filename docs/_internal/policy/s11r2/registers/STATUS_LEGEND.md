...
| **IP** | In Progress | Actively investigating; sources are being consulted and options refined. | You are reading draft-2, plan-v19, specs, code/help snapshots, etc. | Move to **RV** when you have a candidate resolution ready for review. |
