# Ratchetr ADR Reorganization and Rewrite Plan (Integrated v18 — Planning Only)
...
- Create `docs/_internal/policy/s11r2-policy.md` as a **verbatim snapshot** of Policy vCurrent (user-provided). Include stable section anchors suitable for citations by ADRs/specs and this plan.
