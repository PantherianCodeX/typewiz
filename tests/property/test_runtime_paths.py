...
# NOTE: Test removed - with only 2 canonical manifest names (manifest.json, .ratchetr/manifest.json),
# and one being the priority path (.ratchetr/manifest.json), there is no true ambiguity
# scenario to test. If both exist, the priority path wins by design.
